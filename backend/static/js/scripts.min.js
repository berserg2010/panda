  ...
  $(document).ready(function () {
    ...
    if (window.addEventListener("load",AOS.refresh),
      $(".instructor-slider,.testimonials-slider").slick({
        infinite:!0,arrows:!1,dots:!1,nextArrow:'<button class="slick-arrow slick-next"></button>',prevArrow:'<button class="slick-arrow slick-prev"></button>',slidesToShow:1,slidesToScroll:1,autoplay:!0,autoplaySpeed:1e4,speed:500,centerMode:!0,variableWidth:!0,responsive:[{breakpoint:768,settings:{centerMode:!1}}]
      }),
      $(".personalArea-slider").slick({
        infinite:!1,arrows:!1,dots:!1,nextArrow:'<button class="slick-arrow slick-next"></button>',prevArrow:'<button class="slick-arrow slick-prev"></button>',slidesToShow:3,slidesToScroll:1,speed:500,variableWidth:!0,responsive:[{breakpoint:1380,settings:{slidesToShow:2}},{breakpoint:600,settings:{slidesToShow:1}}]
      }),
      $(".timetables-slider").slick({
        infinite:!1,arrows:!1,dots:!1,nextArrow:'<button class="slick-arrow slick-next"></button>',prevArrow:'<button class="slick-arrow slick-prev"></button>',slidesToShow:3,slidesToScroll:1,speed:500,variableWidth:!0,responsive:[{breakpoint:1380,settings:{slidesToShow:2}},{breakpoint:680,settings:{slidesToShow:1}}]
      }),
      $(".file-slider").slick({
        infinite:!1,arrows:!1,dots:!1,nextArrow:'<button class="slick-arrow slick-next"></button>',prevArrow:'<button class="slick-arrow slick-prev"></button>',slidesToShow:3,slidesToScroll:1,speed:500,variableWidth:!0,responsive:[{breakpoint:1380,settings:{slidesToShow:2}},{breakpoint:680,settings:{slidesToShow:1}}]
      }),
      $('[data-fancybox="gallery"]').fancybox({
        beforeShow:function(){$(".caption--image").remove()},afterShow:function(){var t=$(".fancybox-caption"),e=t.clone().addClass("caption--image");$(".fancybox-slide--current .fancybox-content").append(e),t.not(".caption--image").addClass("caption--bottom")}
      }),
      $(".header-menu_, .main-info").on("click", "a", function (t) {
        t.preventDefault();
        var e=$(this).attr("href"),
          a=$(e).offset().top;
        $("html, body").animate({scrollTop:a},900),
          $(".header").removeClass("header-active")
      }),
      $(".header-bar").on("click",function(){
        $(".header").toggleClass("header-active"),$(i).removeClass("open"),$(".modal-overlay").removeClass("open-overlay"),$(".menu").length&&$(".menu").toggleClass("menu-active")
      }),
      ...
      $(document).on("click",function(t){
        var e=$(".header");e.is(t.target)||0!==e.has(t.target).length||$(".form-btn").is(t.target)||$(".header").removeClass("header-active")
      }),
      $(document).on("click",function(t){
        var e=$(".drop");e.is(t.target)||0!==e.has(t.target).length||$(".form-btn").is(t.target)||$(".drop").removeClass("active")
      }),
      $(document).on("click",function(t){
        var e=$(".header-user");e.is(t.target)||0!==e.has(t.target).length||$(".header-user").removeClass("active")
      }),
      $(".slick-current.slick-active .instructor-overlay").on("click",function(){
        var t=$(this).parents(".instructor-video");url=$(t).find(".instructor-url").text(),$(t).addClass("active"),$(t).find("iframe").attr("src",url)
      }),
      $(".tab-list li a").on("click",function(t){
        t.preventDefault(),$(".tab-list li a").removeClass("active"),$(".tab").removeClass("tab-active");var e=$(t.target).attr("href");$(e).addClass("tab-active"),$(this).addClass("active")
      }),
      ...
      $(".grid").masonry({itemSelector:".grid-item",percentPosition:!0}),
      $(".input-textarea textarea").keyup(function(){
        var t=$(this).val().length;$(this).attr("maxlength","1000").parents(".input-textarea").find(".input-textarea__info b").text(1e3-t)
      }),
      
      $("#statistics1").length) {
      var e=new ProgressBar.Circle(statistics1,{color:"#FFB42D",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#FFB42D",width:5},to:{color:"#FFB42D",width:5},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var a=Math.round(e.value()*$("#statistics1-1").text());0===a?e.setText(""):e.setText(a)}});e.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',e.text.style.fontSize="48px",e.animate($("#procent-1").text(),{duration:1500})
    }
    if ($("#statistics2").length) {
      var a=new ProgressBar.Circle(statistics2,{color:"#FFB42D",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#FFB42D",width:5},to:{color:"#FFB42D",width:5},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var a=Math.round(e.value()*$("#statistics2-2").text());0===a?e.setText(""):e.setText(a+"<span>+</span>")}});a.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',a.text.style.fontSize="48px",a.animate($("#procent-2").text(),{duration:1500})
    }
    if ($("#statistics3").length) {
      var s=new ProgressBar.Circle(statistics3,{color:"#FFB42D",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#FFB42D",width:5},to:{color:"#FFB42D",width:5},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var a=Math.round(e.value()*$("#statistics3-3").text());0===a?e.setText(""):e.setText(a+"<span>+</span>")}});s.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',s.text.style.fontSize="48px",s.animate($("#procent-3").text(),{duration:1500})
    }
    if($("#statistics4").length){
      var o=new ProgressBar.Circle(statistics4,{color:"#FFB42D",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#FFB42D",width:5},to:{color:"#FFB42D",width:5},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var a=Math.round(e.value()*$("#statistics4-4").text());0===a?e.setText(""):e.setText(a+"<span>+</span>")}});o.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',o.text.style.fontSize="48px",o.animate($("#procent-4").text(),{duration:1500})
    }
    if($("#perstatistics1").length){
      var e=new ProgressBar.Circle(perstatistics1,{color:"#FFB42D",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#FFB42D",width:5},to:{color:"#FFB42D",width:5},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var a=(e.value()*$("#perstatistics1-1").text()).toFixed(1);0===a?e.setText(""):e.setText(a)}});e.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',e.text.style.fontSize="48px",e.animate($("#perprocent-1").text(),{duration:1500})
    }
    if($("#perstatistics2").length){
      var e=new ProgressBar.Circle(perstatistics2,{color:"#FFB42D",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#FFB42D",width:5},to:{color:"#FFB42D",width:5},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var a=(e.value()*$("#perstatistics2-2").text()).toFixed(1);0===a?e.setText(""):e.setText(a)}});e.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',e.text.style.fontSize="48px",e.animate($("#perprocent-2").text(),{duration:1500})
    }
    ...
    $(".datepicker").length&&$(".datepicker").datepicker({
        dateFormat:"dd-mm-yy",monthNames:["Январь","Февраль","Март","Апрель","Май","Июнь","Июль","Август","Сентябрь","Октябрь","Ноябрь","Декабрь"],dayNamesMin:["Вс","Пн","Вт","Ср","Чт","Пт","Сб"],onSelect:function(t){$(this).parents(".master-datepicker").find(".datepicker-input span").text($(this).val())}
      },
      $.datepicker.regional.ru),
      $(".vocabulary-ico").on("click",function () {
        $(".vocabulary-ico audio").each(function(){this.pause(),this.currentTime=0}),
      ...
      $(".lesson-tabs li a").on("click",function(t){
        t.preventDefault(),$(".lesson-tabs li a").removeClass("active"),$(".lesson-input__copy").removeClass("active");var e=$(t.target).attr("href");$(e).addClass("active"),$(this).addClass("active")
      }),
      ...
      $(".profile-edit").on("click",function(t){
        t.preventDefault(),$(this).parents(".profile").toggleClass("profile-changes")
      }),
      $(".input-cardNumber").attr("type","text").mask("9999 9999 9999 9999",{reverse:!0}),
      $(".input-expiry").attr("type","text").mask("99/99",{reverse:!0}),
      $(".input-cvv").attr("type","text").mask("999",{reverse:!0}),
      $(".personalArea-card__input input").on("focus",function(){
        $(this).parents(".personalArea-card__input").addClass("input-active")
      }).on("blur",function(){""!=!$(this).val()&&$(this).parents(".personalArea-card__input").removeClass("input-active")}),
      ...
      $(".topUpAccount-btn").on("click",function(t){
        t.preventDefault();var e=$(this).attr("href");$(e).addClass("modal-active")
      }),
      ...
      $(".testing-audio audio").on("play",function(t){
        $(".testing-audio audio").each(function(e,a){a!==t.currentTarget&&this.pause()})
      }),
      $(".paint").length
    ){
      var r,
      ...
      document.getElementById("mainCanvas").width=u,
        ...
        l.mousedown(function(t){r=t,d=!0}).mousemove(function(t){
          d && (c.beginPath(),c.moveTo(r.offsetX,r.offsetY),c.lineTo(t.offsetX,t.offsetY),c.strokeStyle=n,c.lineWidth=5,c.lineCap="round",c.stroke(),r=t)}).mouseup(function(){d=!1}).mouseleave(function(){l.mouseup()})}
  });
