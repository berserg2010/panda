...
$(function(){AOS.init()}),
  ...
  $(document).ready(function () {
    ...
    $(".select").on("click", function (t) {
      if (
          $(this).hasClass("active")){var e=t.target,a=$(this).find(".select-text"),s=$(this).find(".select-value");"LI"==e.tagName?($(a).text($(e).text()),$(s).val($(e).text()),$(e).hasClass("color-green")?$(this).find(".select-text").removeClass("color-red").addClass("color-green"):$(e).hasClass("color-red")&&$(this).find(".select-text").removeClass("color-green").addClass("color-red")):"A"==e.tagName&&($(a).html($(e).html()),$(s).val($(e).text())),$(this).removeClass("active")
    ...
    if (
      ...
      $(".modal-close, .modal-overlay, .second-btn").on("click", function () {
        $(i).removeClass("open"),
          $(".modal-overlay").removeClass("open-overlay")
      }),
